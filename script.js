...
function CreateHeader() {
  ...
  logo.setAttribute("style", "width:20%;height:70px; ");
  logo.setAttribute(
    "class",
  ...
  image.setAttribute("style", "width:50%;height:60px; ");
  image.setAttribute("src", "./images/e-shop-logo.png");
  logo.appendChild(image);

  var search = document.createElement("div");
  search.setAttribute("style", "width:30%;height:70px");
  search.setAttribute(
    "class",
    "d-flex justify-content-center align-items-center"
  );
  ...
  searchInput.setAttribute("style", "width:90%; height:40px");
  ...
  menuDiv.setAttribute("style", " height:60px; width:20%;");
  ...
  if (isLoggedIn()) {
    ...
    signInOptions.innerText = "SignIn";
    ...
    signUpOptions.innerText = "SignUp";
...
function createCart(data) {
  ...
  for (let product of data) {
    ...
    cartDiv.setAttribute(
      "style",
      "width:30%;height:430px;box-shadow:10px 10px 10px grey;"
    );
    ...
    p.innerHTML =
      "Price : <span class:'text-success'>" + product.price + " Rs. </span>";
...
function SignInComponent() {
  ...
  container.setAttribute(
    "style",
    "border:2px solid green;box-shadow:10px 10px 10px grey; padding:20px; width:30%; height:auto;left:50%;top:50%;position:absolute;transform:translate(-50% , -50%)"
  );
  ...
  signUpLabel.setAttribute("style", "padding:0px;margin-left:10px;");
  signUpLabel.setAttribute("class", "text-danger mt-5");
...
function SignUpComponent() {
  ...
  container.setAttribute(
    "style",
    " border:2px solid red;box-shadow:10px 10px 10px grey; padding:20px;width:30%;height:auto;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%)"
  );
  ...
  signInLabel.innerText = "Already have an account";
...
function  form(){   
  ...
  container.setAttribute("style","display: flex;flex-direction: column;row-gap: 12px;box-shadow:5px 5px 5px 3px grey;padding:25px;padding-left:80px;");    

  var heading = document.createElement("h2");
  heading.innerText="Shipping Details";
  ...
  nameInput.setAttribute("style","width:550px;");
  ...
  mobileInput.setAttribute("placeholder","Enter Your Mobile No.");
  mobileInput.setAttribute("id","mobile");
  mobileInput.setAttribute("style","width:550px;");
  ...
  addressInput.setAttribute("style","width:550px;");

  var buttonDiv= document.createElement("div");
  buttonDiv.setAttribute("style","display:flex");
  var placeOrder = document.createElement("button");
  placeOrder.setAttribute("class","btn btn-success mt-3");
  placeOrder.innerText="Place Order";
  placeOrder.setAttribute("style","height:45px;width:110px");
  placeOrder.addEventListener("click",()=>{
       ...
       if(mobile.length!=10 && (mobile.match("^[0-9a-zA-Z]+$"))){
       ...
       if(name==""||mobile==""|address==""){
          ...
          var obj= {name:name,mobile:mobile,address:address,cartItems:cartItems};
          OrderList.push(obj);
  ...
  backButton.setAttribute("class","btn btn-primary ml-4 mt-3");
  backButton.innerText="Back";
  backButton.setAttribute("style","height:45px;width:110px");
  backButton.addEventListener("click",()=>{
        backcheckout();
  });
  
  buttonDiv.appendChild(placeOrder);
...
function viewCartDetails(){
  ...
  var currentUserCartList = cartList.find((obj) => {
   ...
   console.log(currentUserCartList);
  var cartItems = currentUserCartList.cartItems;
  var container = document.createElement("div");
  ...
  rowDiv.setAttribute("style", "height:95%;width:100%;");
  rowDiv.setAttribute("id","rowDiv");

  var leftContainer = document.createElement("div");
  leftContainer.setAttribute("id","List");
  leftContainer.setAttribute("class", "col-md-8");
  leftContainer.setAttribute("style", " height:100%; width:45%;");

  var table = document.createElement("table");
  table.setAttribute("class","table");
  table.setAttribute("style","border:1px solid grey;border-radius:12px;");


  var thead = document.createElement("thead");
  thead.setAttribute("style","background-color:#E0ABE5;font-weight:bold;");
  ...
  backBtn.setAttribute("class","btn btn-primary ml-4 mt-3");
  backBtn.innerText="Back";
  backBtn.setAttribute("style","height:45px;width:110px;");
